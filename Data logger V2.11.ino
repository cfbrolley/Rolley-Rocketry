...
#define chargepin 6
#define buzzer 5
#define logtime 10 //<--slows down time between logs by this much. current loop can run every 10-11ms which is 100 lines of data per second, adding 10ms this slows it down to 50. 
